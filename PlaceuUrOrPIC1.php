    ...
    <div class="container-fluid">
      ...
      <div class="container">
        <h2 class="text-center text-capitalize">
          <strong>Place your new order here !&nbsp; &nbsp; &nbsp;</strong>
        </h2>
        <br />
        <form id="orderplacing" name="orderplacing" method="post">
          ...
          <br /><input
            ...
            required
          /><br />
          <label for="cate"><b>Category Code/Codes* :-</b></label
          ><br />
          <input type="text" name="cate" id="cate" placeholder=" 1" required />
          <input type="text" name="brand1" id="brand1" placeholder=" 2" />
          <input type="text" name="brand2" id="brand2" placeholder=" 3" />
          <br />
