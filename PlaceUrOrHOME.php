    ...
    <div class="container-fluid">
      ...
      <div class="container">
        <h2 class="text-center text-capitalize">
          <strong
            >Tell us What Kind of laptop You are searching !&nbsp; &nbsp;
            &nbsp;</strong
          >
        </h2>
        <br />
        <form id="orderplacing" name="orderplacing" method="post">
          <h3>
          ...
          <label for="comname"><b>Purpose(optional) :-</b></label> <br /><input
            type="text"
            name="Company Name"
            id="comname"
            required
          ...
          <hr />
          <h3>
            <b><u>Details about searching Laptop</u></b>
          </h3>
          ...
          <select name="Province">
            ...
            <option value="9">Vivo</option></select
          ><br /><br />
          ...
          <br />
          <label for="Lbrand"><b>Model* :-</b></label>
          <input type="text" name="model" id="model" required />
          <label for="Lmodel"><b>Model No* :-</b></label>
          <input type="text" name="modelno" id="Lmodelno" required /><br />
          <label for="processor"><b>Processor* :-</b></label>
          <input type="text" name="processor" id="processor" required />
          <label for="gener"><b>Generation* :-</b></label>
          <input type="text" name="gener" id="gener" required /><br />
          ...
          <div id="additionalFields" style="display: none">
            ...
            <input type="text" id="ssname" name="ssname" required /><br />
            ...
            <label for="postal"><b>Postal Code/ZIP* :-</b></label
            ><br />
            <input type="text" name="Postal Code" id="spostal" required /><br />
