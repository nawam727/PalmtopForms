     ...
     <br>
		<div class="container">
			<form id="orderplacing" name="orderplacing" method="post" >
				<center><input type="text" placeholder="Search your LAPTOP"><input type="submit" value="SEARCH">
				</center>
			</form> <br>
			<h2 class="text-center text-capitalize"><strong>Enter your details here to place the order!&nbsp; &nbsp;
					&nbsp;</strong></h2>
			<br>
